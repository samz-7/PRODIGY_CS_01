...
#The encrypt function shifts each letter in the message to the right by the specified shift value, wrapping around to the beginning of the alphabet if necessary.
#The decrypt function does the opposite, shifting each letter to the left by the specified shift value.
